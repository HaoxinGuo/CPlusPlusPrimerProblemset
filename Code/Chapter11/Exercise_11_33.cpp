...
int main( )
{
	...
	ifstream map_file("F:\\Cstudy\\CPlusPlusPrimerProblemset\\Code\\Chapter11\\data\\11-33-2.txt"); // open transformation file 
	if (!map_file)			  // check that open succeeded
		throw runtime_error("no transformation file");
	
	ifstream input("F:\\Cstudy\\CPlusPlusPrimerProblemset\\Code\\Chapter11\\data\\11-33-1.txt");	// open file of text to transform
